...
$(function(){
  ...
  $("#reservation").on('change', function(){
    ...
    window.location = 'view/admin/payroll/payroll.php?range='+range;
  });

  $('#payroll').click(function(e){
    e.preventDefault();
    $('#payForm').attr('action', 'view/admin/payroll/all_employee_payroll.php');
    $('#payForm').submit();
  });

  $('#payslip').click(function(e){
    e.preventDefault();
    $('#payForm').attr('action', 'view/admin/payroll/payslip_generate.php');
    $('#payForm').submit();
  });
